...
const Switch = (props: Props) => {
  ...
  return <input type="checkbox" className={clsx("disabled:cursor-not-allowed disabled:opacity-40", styles["switch"], colors[color], sizes[size], className)} disabled={isLoading || disabled} {...rest} />;
};
